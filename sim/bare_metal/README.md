...
```
 Кое что зашагало, однако программа поменяла сама себя во время выполнения. Это потому что я у меня инструкция SW в симуляторе почему работает с безнаковым иммедиатом, а должна со знаком.  Это я разберусь.
