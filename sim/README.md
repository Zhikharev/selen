...
благодаря ей они видят инструкции одинаково.

Предполагается использовать эти программы в скриптах, поэтому много аргументов передается через командную строку. 
